...
export type RecordsCreateModalContextInput = {
  exerciseId: number;
  weight: number;
  reps: number;
};

export default class RecordsCreateModalContext extends SubmittableModalViewModelBase<RecordsCreateModalContextInput, Promise<boolean>> {
  data: RecordsCreateModalContextInput | undefined = undefined;
  constructor() {
    super();
    makeObservable(this, {
      close: override,
  ...
  *submitAndClose(model: RecordsCreateModalContextInput) {
    try {
