...
export const lightThemeOptions: TrainingHelperThemeOptions = {
  components: {
    MuiDataGrid: {
      styleOverrides: {
        root: {
  ...
  palette: {
    ...
    collectionTiles: {
      ...
      comment: {
        borderColor: '#8750d8',
        backgroundColor: '#8750d8',
        color: colors.common.white,
      },
      collectionCompleted: {
        borderColor: colors.green[700],
        backgroundColor: colors.green[700],
        pinColor: colors.green[700],
        color: colors.common.white,
      },
      collectionFailed: {
        borderColor: colors.red[300],
        backgroundColor: colors.red[300],
        pinColor: colors.red[400],
        color: colors.common.white,
      },
      collectionInProgress: {
        borderColor: colors.amber[700],
        backgroundColor: colors.amber[700],
        pinColor: colors.amber[700],
        color: colors.common.white,
      },
      collectionPlanned: {
        borderColor: '#d9d9d9',
        backgroundColor: '#d9d9d9',
        pinColor: colors.grey[900],
      },
    },
    background,
    divider,
